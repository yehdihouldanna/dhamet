...
class Game():
    def __init__(self,player1,player2,n=9,file_name=None):
        self.game = State(n)
    ...
    def turn(self):
        ...
        for k in range(len(moves)-1):
            ...
            if not moved:
                break
        if moved:
            # if self.game.white_score + self.game.black_score <=15:
            #     self.game.show_board()
            self.game.show_board()
...
if __name__=="__main__":
    ...
    match = Game(Player1,Player2,n=9,file_name=file_name)
